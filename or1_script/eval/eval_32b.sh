...
MODEL_PATH=${MODEL_PATH:-Skywork/Skywork-OR1-Math-7B}
DATA_PATH=${DATA_PATH:-or1_data/eval/aime24.parquet}
TASK_NAME=${TASK_NAME:-Aime24_Avg32-Skywork_OR1_Math_7B}
SAMPLES=${SAMPLES:-32}
...
python3 -m verl.trainer.main_generation \
    ...
    data.path=$DATA_PATH \
    data.output_path=./outputs/evalation/$TASK_NAME.pkl \
