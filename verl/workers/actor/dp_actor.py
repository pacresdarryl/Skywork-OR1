...
class DataParallelPPOActor(BasePPOActor):
    ...
    def get_entropy_metric(self,batch, ent_ctrl_dict):
        ...
        metrics = {
            ...
            "actor/pg_grad_ratio" : pg_grad_scale / (pg_grad_scale + entropy_grad_scale_with_coeff),
            "actor/entropy_grad_ratio" : entropy_grad_scale_with_coeff / (pg_grad_scale + entropy_grad_scale_with_coeff),
